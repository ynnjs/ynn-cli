...
function init( dest, options = {} ) {
    ...
    const controllerDir = path.resolve( dest, options.controllerDir || config.controllerDir );
    const serviceDir = path.resolve( dest, options.serviceDir || config.serviceDir );
    const configDir = path.resolve( dest, options.configDir || config.configDir );
